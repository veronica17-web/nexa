...
const {views,getPopups,dupePopups,sortpopup}= require("../controller/popupController")
const {carEnquiry, getOncarEnquiry ,dupeCarEnquiries , sortCarEnquiries}=require("../controller/carEnquirycontroller")
...
const{ contactForm,getcontactForm }=require("../controller/contactController")
const {feedbackForm, getfeedbackForm }=require("../controller/feedbackController")
